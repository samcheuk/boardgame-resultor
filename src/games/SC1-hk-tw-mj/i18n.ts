...
const en = {
  ...
  fanTableTitle: 'HK-style Taiwanese Mahjong fan chart',
  immediatePayTitle: 'Pay immediately',
  fanColName: 'Hand',
  fanColFan: 'Fan',
  fanColDescription: 'Description',
  fanTableSource: 'Source: twmahjong.com',
  leaderboardEmpty: 'No standings yet. Add results or incense money first.',
  leaderboardResultsTitle: 'Results standings',
  leaderboardIncenseTitle: 'Incense money standings',
  leaderboardResultsEmpty: 'No result standings yet.',
  leaderboardIncenseEmpty: 'No incense money standings yet.',
  leaderboardResultMeta: '{{games}} games',
  leaderboardIncenseMeta: '{{count}} records',
...
const messages: Record<Locale, Record<HkTwMjTranslationKey, string>> = {
  ...
  'zh-TW': {
    ...
    tabHelper: '番數表',
    tabsLabel: '紀錄分類',
    fanTableTitle: '台灣麻雀番數表（港式）',
    immediatePayTitle: '即時付錢',
    fanColName: '名稱',
    fanColFan: '番數',
    fanColDescription: '解說',
    fanTableSource: '來源：twmahjong.com',
    leaderboardEmpty: '尚未有排行資料，請先新增賽果或香油錢。',
    leaderboardResultsTitle: '賽果排行',
    leaderboardIncenseTitle: '香油錢排行',
    leaderboardResultsEmpty: '尚未有賽果排行。',
    leaderboardIncenseEmpty: '尚未有香油錢排行。',
    leaderboardResultMeta: '{{games}} 場',
    leaderboardIncenseMeta: '{{count}} 筆',
    addMenuLabel: '新增紀錄',
    addResult: '新增賽果',
    addIncense: '新增香油錢',
