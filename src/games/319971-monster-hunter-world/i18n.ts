...
const en = {
  ...
  expandHunter: 'Expand',
  collapseHunter: 'Collapse',
  sectionSearchPlaceholder: 'Search equipment & items...',
  noSearchResults: 'No equipment or items match your search.',
...
const messages: Record<Locale, Record<MhwTranslationKey, string>> = {
  ...
  'zh-TW': {
    ...
    expandHunter: '展開',
    collapseHunter: '收合',
    sectionSearchPlaceholder: '搜尋裝備及道具...',
    noSearchResults: '沒有符合的裝備或道具。',
