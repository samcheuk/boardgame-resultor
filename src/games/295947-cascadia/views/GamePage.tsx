...
import { cascadiaText } from '../i18n';
import { CascadiaRecordForm } from './RecordForm';
...
function CascadiaRecordList({ game }: Pick<GamePageProps, 'game'>) {
  ...
  async function handleDelete(recordId: string) {
    if (
      !window.confirm(
        cascadiaText(locale, 'deleteConfirm', {
...
export default function CascadiaGamePage({
  game,
  mode,
  recordId,
}: GamePageProps) {
  ...
  return <CascadiaRecordList game={game} />;
}
